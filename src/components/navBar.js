...
function NavBar(props) {
  return (<React.Fragment>
      <Navbar className="lenavbar" expand="lg" variant="dark" onToggle={props.handleNavCloseNodeInfo}>
        <a href="http://www.londondjangocollective.com/" target="_parent" className="LDC-navbar"><img src={logo_small} className="LDC_logo" alt="London Django Collective logo"></img></a>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          ...
          <div className='navbar-links'>
            <Button variant="outline-primary" className="navbar-buttons" target="_parent" href="http://www.londondjangocollective.com/djangoverse/forms/player/list">
              Add players
            </Button>
          </div>
